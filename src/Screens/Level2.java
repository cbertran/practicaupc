...
public final class Level2 implements IScreen {
	...
	@Override
	public void execute() {
		Utilsselenium.findByIdAndSendKeys("input","selenium");
		Utilsselenium.findByIdAndClick("next");
	}
}
